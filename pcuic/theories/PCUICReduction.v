...
(*
    ...
    Lemma OnOne2_eq_fixcontext P mfix mfix' :
      OnOne2 (fun d d' => P d d' × (dname d, dtype d, rarg d) = (dname d', dtype d', rarg d')) mfix mfix' ->
      fix_context mfix = fix_context mfix'.
    Proof.
      unfold fix_context, mapi. generalize 0 at 2 4 as n. intro n.
      induction 1 in n |- * => //=; f_equal.
      - apply snd in p. noconf p. now rewrite H H0.
      - eapply IHX.
    Qed.
